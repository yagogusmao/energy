...
import {
    ...
    ContainerGrafico, RadioButtonDiv, RadioButtonLabel, Observacao, ContainerPesquisaApontamentos
} from './Style';
    ...
    return (
        <>
            <MenuTab>
                ...
                { label: 'Faturar', value: "faturamento", icon: 'pi pi-fw pi-pencil' },
            ...
            {itemAtivo === "iniciar" ?
                ...
                itemAtivo === "faturamento" ?
                    <ContainerPesquisaApontamentos>
                        <div className="inputs">
                            <InputFloat name="obraPesquisa" label="Código da obra" value={obraPesquisa} onChange={handleInputChange} />
                            <Button style={{
                                backgroundColor: '#ce5f52', borderColor: '#e57164',
                                WebkitBoxShadow: '2px 2px 5px 0px rgba(0,0,0,0.75)',
                                MozBoxShadow: '2px 2px 5px 0px rgba(0,0,0,0.75)',
                                boxShadow: '2px 2px 5px 0px rgba(0,0,0,0.75)'
                            }} label="Pesquisar obra" onClick={pesquisarObra} className="p-button-raised p-button-rounded" />
                            <Button style={{
                                backgroundColor: '#ce5f52', borderColor: '#e57164',
                                WebkitBoxShadow: '2px 2px 5px 0px rgba(0,0,0,0.75)',
                                MozBoxShadow: '2px 2px 5px 0px rgba(0,0,0,0.75)',
                                boxShadow: '2px 2px 5px 0px rgba(0,0,0,0.75)'
                            }} label="Faturar obra" onClick={faturarObra} className="p-button-raised p-button-rounded" />
                        </div>
                        <div className="tabela" style={{marginTop: '10px'}}>
                            <DataTable
                                value={apontamentosPesquisa}
                                rows={10}
                                emptyMessage={"Nenhum apontamento nesta obra."}
                            >
                                <Column
